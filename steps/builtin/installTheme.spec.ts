...
describe('installTheme', () => {
    ...
    it('should install theme from external HTTP URL', () => {
        ...
        expect(result[0].themeData.url).toBe('https://playground.wordpress.net/cors-proxy.php?https:');
    });
    ...
    it('should handle HTTP URLs with cors-proxy', () => {
        ...
        expect(result[0].themeData.resource).toBe('url');
        expect(result[0].themeData.url).toBe('https://playground.wordpress.net/cors-proxy.php?http:');
    });
    ...
    it('should have correct metadata', () => {
        expect(installTheme.description).toBe('Install a theme');
