...
describe('sampleContent', () => {
    describe('toV1()', () => {
        ...
        it('should create posts with correct titles', () => {
            ...
            expect(result.steps[0].code).toContain('Hello Sample Content');
            expect(result.steps[1].code).toContain('Second Sample Content');
            expect(result.steps[2].code).toContain('Third Sample Content');
            expect(result.steps[3].code).toContain('Fourth Sample Content');
            expect(result.steps[4].code).toContain('Fifth Sample Content');
        });
        ...
        it('should have unique titles for each post', () => {
            ...
            const titles = result.steps.map(step => {
