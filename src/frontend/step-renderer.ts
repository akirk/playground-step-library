/**
 * Step Renderer
 * Creates DOM elements for blueprint steps with dependency injection
 */
...
/**
 * Create a step DOM element from step definition
 *
 * @param name - The step name
 * @param data - The step definition
 * @param showCallbacks - Callbacks for conditional field visibility
...
export function createStep(
	...
	if (data.mine) {
		...
		delPath.setAttribute('d', 'M3 6h18M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m3 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6h14z');
		...
		renamePath1.setAttribute('d', 'M12 20h9');
		const renamePath2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
		renamePath2.setAttribute('d', 'M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z');
		renameIcon.appendChild(renamePath1);
		renameIcon.appendChild(renamePath2);
	...
	saveStep.innerText = 'Save to My Steps';
